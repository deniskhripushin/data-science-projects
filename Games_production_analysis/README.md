...
| :---------------------- | :---------------------- | :---------------------- |
| [Интернет-магазин компьютерных игр] | Анализируем продажи, платформы, жанры, регионы и проверяем статистические гипотезы для закономерностей успешности компьютерных игр. | *pandas*, *scipy* |
